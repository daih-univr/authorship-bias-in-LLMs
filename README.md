...
[![Graphical abstract of the paper](readme_assets/graphical-abstract.jpg)](https://github.com/daih-univr/authorship-bias-in-LLMs)

</div>

GitHub repo with the materials for the paper:

> Marco Rospocher, Massimo Salgaro and Simone Rebora. [Machines Prefer Humans as Literary Authors: Evaluating Authorship Bias in Large Language Models](https://doi.org/10.3390/info17010095). Information, vol. 17, no. 1. ISSN: 2078-2489 (2026) DOI: 10.3390/info17010095
...
* ```results```: tables and plots with all the results and statistical tests
...
## Full bibtex reference to the published paper:
