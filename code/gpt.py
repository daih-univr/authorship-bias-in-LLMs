...
# Set your OpenAI API key. It's recommended to set this as an environment variable:
# os.environ["OPENAI_API_KEY"] = "YOUR_API_KEY_HERE"
# If not using an environment variable, you can pass it directly:
...
OPENAI_MODEL = "gpt-4o-mini" # Or "gpt-4", "gpt-4o", etc. based on your needs and access
...
Ecco il questionario che devi compilare:
  ...
  while True:
      try:
          ...
          risposta = clean(response.choices[0].message.content.strip())
          break
